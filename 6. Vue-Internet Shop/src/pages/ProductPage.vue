<template>
  <main
    ...
    v-if="productLoading"
  >
    <div><img src="..\public\img\loadProduct.gif" alt="Загрузка товара..."></div>
  </main>
  <main
    class="content container"
    style="text-align: center"
          ...
          >
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li
                  class="colors__item"
                  v-for="(color, index) in product.colors.code"
                  :key="index"
                >
            ...
            <div class="item__row" style="margin-bottom: 10px">
              <div class="form__counter">
                <button
                  type="button"
                  aria-label="Убрать один товар"
                  :disabled="this.productAmount < 2"
                  @click.prevent="minusProductInput()"
                >
                ...
                <button
                  ...
                  :disabled="this.productAmount > 19"
                  @click.prevent="plusProductInput()"
                >
                  <svg width="12" height="12" fill="currentColor">
            ...
            <div style="text-align: center" v-show="productAdded">Товар успешно добавлен в корзину!</div>
            <div style="text-align: center" v-show="productAddSending">Добавляем товар в корзину...</div>
          </form>
        </div>
      </div>
...
export default {
  ...
  methods: {
    ...
    addToCart() {
      ...
      this.$store.commit('updateProductAddSending', this.productAddSending);
    ...
    loadProduct() {
      ...
      this.productLoadingFailled = false;
      clearTimeout(this.loadProductTimer);
      this.loadProductTimer = setTimeout(() => {
        axios
          .get(API_BASE_URL + "/api/products/" + this.$route.params.id)
          .then((responce) => (this.productData = responce.data))
          .catch(() => (this.productLoadingFailled = true))
